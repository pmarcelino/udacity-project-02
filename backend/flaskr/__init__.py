...
def build_categories_dict():
    """Returns a dictionary of categories (ID as the key, type of category as the value).

    Args:
        None

    Returns:
        categories_dict (dict): Categories (ID as the key, type of category as the value).
...
def create_app(test_config=None):
    ...
    def handle_questions_post():
        ...
        # If searchTerm==None, returns all questions
